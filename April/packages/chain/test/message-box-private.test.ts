...
import { AgentCode, AgentDetails, AgentId, Message, MessageNumber, MessageText } from "../src/message-box";
import { MessageBoxPrivate, ProcessMessageProgram } from "../src/message-box-private";
...
describe("messagebox tests", () => {
  ...
  it("should update the state on a valid message", async () => {
    ...
    const tx1 = await appChain.transaction(agentPublicKey, () => {
      messageBox.processMessage(proof)
    });
